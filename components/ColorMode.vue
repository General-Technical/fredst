  ...
  <div class="flex items-center">
    <button @click="changeMode">
      <svg
        ...
        viewBox="0 0 16 16"
        class="w-8 h8 md:w-5 md:h-5 mt-6 md:mt-0 hidden dark:block fill-secondary hover:fill-hover trans"
      >
        <path
    ...
    <button @click="changeMode">
      <svg
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 16 16"
        class="w-8 h8 md:w-5 md:h-5 mt-6 md:mt-0 rotate-127 dark:hidden fill-tertiary hover:fill-hover trans"
      >
        <path
